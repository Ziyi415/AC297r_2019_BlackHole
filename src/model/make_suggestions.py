...
def decision_making_further_std_punishment(day_current_str, end_day_str, databook, std_dict, days_to_trigger, punish_level=0.6, distance = True, use_as_evaluate=False):
    ...
    # end_day_str: YYYY-MM-DD (str) (included)
    # days_to_trigger: days to trigger (int)
    each_day_reward = processing_data.all_day_reward(day_current_str, end_day_str, databook, std_dict, further_std=True, punish_level=punish_level, distance = True, use_as_evaluate=use_as_evaluate)
...
def decision_making_time_std_punishment(day_current_str, end_day_str, databook, std_dict, days_to_trigger, punish_level=1, distance = True, use_as_evaluate=False):
    ...
    # end_day_str: YYYY-MM-DD (str) (included)
    # days_to_trigger: days to trigger (int)
    each_day_reward = processing_data.all_day_reward(day_current_str, end_day_str, databook, std_dict, time_std=True, punish_level=punish_level, distance = True, use_as_evaluate=use_as_evaluate)
...
def decision_making_sampling(day_current_str, end_day_str, databook, std_dict,  days_to_trigger, punish_level=0, distance = True, use_as_evaluate=False):
    each_day_reward = processing_data.all_day_reward(day_current_str, end_day_str, databook, std_dict, sampled=True, punish_level = punish_level, distance = True, use_as_evaluate=use_as_evaluate)
