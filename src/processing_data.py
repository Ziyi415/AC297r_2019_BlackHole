...
def all_day_reward(day_current_str, end_day_str, time_std=False, further_std=False, punish_level=1, sampled=False):
    """
    ...
    return telescopes_day_reward / sum(settings.weights)
